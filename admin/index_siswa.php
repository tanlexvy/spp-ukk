            ...
            <div class="col-md-6 col-lg-3">
              <div class="card card-hover">
                <div class="box bg-cyan text-center">
                  ...
                  <h6 class="text-white">Kelas</h6></br>
                  <a href="kelas.php">More</a>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
                  ...
                  <h6 class="text-white">Siswa</h6></br>
                  <a href="siswa.php">More</a>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3">
              <div class="card card-hover">
                <div class="box bg-warning text-center">
                  ...
                  <h6 class="text-white">Pembayaran SPP</h6></br>
                  <a href="pembayaran_spp.php">More</a>
                </div>
              </div>
            </div>
            <!-- Column -->
